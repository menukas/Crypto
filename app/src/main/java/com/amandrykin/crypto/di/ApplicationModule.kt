package com.amandrykin.crypto.di
...
import com.amandrykin.crypto.data.local.preferences.PreferencesStorage
...
class ApplicationModule {
    ...
    @Provides
    @Singleton
    fun provideSharedPreferencesStorage(@ApplicationContext context: Context): PreferencesStorage {
